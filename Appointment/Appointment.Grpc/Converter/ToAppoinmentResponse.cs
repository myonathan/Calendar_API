    ...
    public class ToAppoinmentResponse : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            return new AppointmentResponse
            {
                ...
                StartDate = Timestamp.Parser.ParseJson(JsonConvert.SerializeObject(concreteValue.StartDate)),
                EndDate = Timestamp.Parser.ParseJson(JsonConvert.SerializeObject(concreteValue.EndDate))
            };
        }
    }
}
